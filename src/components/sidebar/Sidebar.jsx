  ...
  return (
    ...
    <div className="menu-container">
      ...
      <Menu mode="inline" theme="light" defaultSelectedKeys={["1"]}>
        ...
        <Menu.Item key="2" icon={<ProjectOutlined />}><Link to="/projects">Projets</Link></Menu.Item>
        <Menu.Item key="3" icon={<ScheduleOutlined />}><Link to="/kanban">Kanban</Link></Menu.Item>
        ...
        <Menu.Item key="6" icon={<CalendarOutlined />}><Link to="/calendar">Calendrier</Link></Menu.Item>
        <Menu.Item key="7" icon={<MessageOutlined />}><Link to="/messages">Messages</Link></Menu.Item>
